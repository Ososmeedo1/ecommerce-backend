...
productRouter.post('/add', multerHost(extensions.Images).array("images", 10), auth(['Admin']), validationMiddleware(productSchema.addProduct), checkIfIdsExist(Brand), errorHandle(productController.addProduct))
